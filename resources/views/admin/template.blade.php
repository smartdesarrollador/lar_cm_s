      ...
      <div class="col-md-3 left_col">
        <div class="left_col scroll-view">
          ...
          <div class="navbar nav_title" style="border: 0;">
            <a href="index.html" class="site_title"><i class="fa fa-home"></i> <span>Panel de Control</span></a>
          </div>
          ...
          <div class="profile">
            ...
            <div class="profile_info">
              ...
              <h2>{{ view()->share('nombre', \Auth::user()->name)}}</h2>
            </div>
          </div>
          <!-- /menu prile quick info -->
...
@include('admin.footer')
  ...
  {!! Html::script('admin/js/flot/js/maps/jquery-jvectormap-world-mill-en.js') !!}
  ...
  <!-- /footer content -->
         ...
         <!-- script js para textarea trumbowyg -->
